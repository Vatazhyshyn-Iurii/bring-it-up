...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function initMask() {
      var setCursorPositiion = function setCursorPositiion(position, elem) {
        elem.focus();
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "changeSlide",
    value: function changeSlide(btnClass, num) {
      var _this2 = this;

      document.querySelectorAll(btnClass).forEach(function (item) {
